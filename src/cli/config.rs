...
pub fn make_agent(cfg: &Config) -> motif::core::agent::Agent {
    use motif::core::agent::Agent;
    use motif::core::provider::OpenAIProvider;
    use motif::tools;
    ...
    Agent::new(provider)
        .history(motif::core::history::FileHistory::new(None))
        .model(&cfg.model)
        .max_iterations(100)
        .tool(tools::search::register())
        .tool(tools::read::register())
        .tool(tools::write::register())
}
